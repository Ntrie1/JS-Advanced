...
const createTemplate = (onSubmitCreate) => html`
<section id="create">
<div class="form">
  <h2>Create Offer</h2>
  <form class="create-form" @submit=${onSubmitCreate}>
...
export async function createPage(ctx){
    ...
    ctx.render(createTemplate(createSubmitHandler(onSubmitCreate)));


    async function onSubmitCreate({title,        
        imageUrl,
        category,        
        description,        
        requirements,        
