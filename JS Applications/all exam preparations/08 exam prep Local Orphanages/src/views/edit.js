...
import { editPost, getSpecificItemById } from "../data/services.js";
...
<form @submit=${onEdit} id="edit">
  ...
  export async function editPage(ctx){
    ...
    let itemData = await getSpecificItemById(itemId)
    ...
    async function onEdit({ title, description, imageUrl, address, phone }){
        ...
        await editPost(itemId, { title, description, imageUrl, address, phone });
