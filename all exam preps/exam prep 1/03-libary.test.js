...
describe('Library test',()=>{
    ...
    describe('findBook tests',()=>{
        ...
        it('valid input - not available book',()=>{
            expect(library.findBook(["Troy", "Life Style", "Torronto"], 'JS doc')).to.equal('The book you are looking for is not here!');
        });
    });
    ...
    describe('arrangeTheBooks tests',()=>{
        ...
        it('invalid input - negative number',()=>{
            expect(() =>library.arrangeTheBooks(-17)).to.throw('Invalid input');
        });
